...
const Post = ({ post, fetchPosts }) => {
  ...
  return (
    <li className="p-3 my-5 bg-yellow-400 text-stone-600" key={post.id}>
      <h1 className="font-bold">Title: {post.title}</h1>
      <p>Actors: {post.actors}</p>
      <p>Release Year: {post.year}</p>

      <button
        className="text-blue-600 mr-5 bg-yellow-500 px-2 rounded-sm"
      ...
      <button
        className="text-red-500 px-2 bg-yellow-500 rounded-sm"
